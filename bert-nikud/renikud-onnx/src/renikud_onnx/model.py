...
class HebrewNikudModel(nn.Module):
    ...
    Outputs:
    - vowel_logits: 8 classes (none, patah, tsere, hirik, holam, qubut, shva, vocal shva)
    - dagesh_logits: binary (dagesh presence)
    - sin_logits: binary (sin/shin dot)
    - stress_logits: binary (stress mark)
    - prefix_logits: binary (prefix boundary)
    """
    ...
    def __init__(
        ...
        self.vowel_classifier = nn.Linear(self.hidden_size, 8)
        ...
        self.prefix_classifier = nn.Linear(self.hidden_size, 1)
    ...
    def forward(self, input_ids: torch.Tensor, attention_mask: torch.Tensor):
        ...
        Returns:
            Tuple of (vowel_logits, dagesh_logits, sin_logits, stress_logits, prefix_logits)
        """
        # Get BERT outputs
        ...
        return vowel_logits, dagesh_logits, sin_logits, stress_logits, prefix_logits
